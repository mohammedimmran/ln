                ...
                <div class="container" style="max-width:30rem">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="user_email" name="user_email" aria-describedby="emailHelp" required="required">
                        ...
                        <a href="../user/index.php" class="text-success">New user ? register here</a>
                    </form>
