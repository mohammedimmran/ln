            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img
                        class="d-block  w-100"
                        style="height:70vh"
                        src="https://thumbs.dreamstime.com/b/cute-autumn-leaf-cute-autumn-leaf-cartoon-character-156215982.jpg"
                        alt="First slide">
                </div>
...
while($row = mysqli_fetch_assoc($result)){
    ...
    <div class="card ">
      ...
      <div class="card-body">
        ...
        <p class="card-text"><small class="text-muted">seller :'.$seller_name.'</small></p>
      <a href="buy.php?plant_id='.$plant_id.'&plant_name='.$plant_name.'&seller_id='.$seller_id.'&seller_name='.$seller_name.'&plant_price='.$plant_price.'" class="btn btn-primary btn-apply mt-4">Buy</a>
