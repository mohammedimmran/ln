        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                <div class="container" style="max-width:30rem">
                    <h1 class="text-success ">seller Registration</h1>
                    <form method="POST" data-aos="fade-right">
                        <div class="form-group">
                            <label for="exampleInputEmail1">
                                Name</label>
                            <input type="text" class="form-control" id="comp_name" name="seller_name" aria-describedby="emailHelp" required="required">
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="comp_email" name="seller_email" aria-describedby="emailHelp" required="required">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">
                        Mobile Number</label>
                    <input type="text" class="form-control" id="comp_name" name="seller_number" aria-describedby="emailHelp" required="required">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="seller_password" id="exampleInputPassword1" required="required">
                </div>

                <button type="submit" class="btn btn-primary font-weight-leight m-2" name="register">Submit</button>
                <a href="seller_login.php" class="text-success">Already have an account ? login here</a>
                </form>
